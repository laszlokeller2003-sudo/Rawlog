...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: '🍽️',
    color: '#F97316',
    subcategories: ['Breakfast', 'Lunch', 'Dinner', 'Snack', 'Cheat Meal', 'Alcohol', 'Fasting', 'Supplements'],
    enabled: true,
    order: 5,
  },
  {
  ...
  },
  {
    ...
    icon: '⚡',
    color: '#6366F1',
    subcategories: ['Deep Work', 'Meeting', 'Planning', 'Procrastinated', 'Finished project', 'Brainstorm', 'Flow State', 'Overtime', 'Break'],
    enabled: true,
    order: 8,
  },
  {
    ...
    icon: '🏥',
    color: '#EC4899',
    subcategories: ['Medication', 'Doctor visit', 'Sick', 'Headache', 'Pain', 'High energy', 'Low energy', 'Symptom', 'Supplement'],
    enabled: true,
    order: 9,
  },
]
